...
//    glm::vec2 Position;
    ...
    std::vector<Spaceship> * Ship_pntr;
//    Spaceship * Gunner1_p;
...
//    }
    ...
    void init(const GLuint numOfVertices, std::vector<GLfloat> surfaceVerts, std::vector<Spaceship> * ship_pntr, Shader * shader, GLuint vao, std::vector<GLfloat> shipPolarCoords)
    {
        NumOfVertices = numOfVertices;
        //        Vbos_vertices_p = vbos_vertices_p;
        SurfaceVerts = surfaceVerts;
